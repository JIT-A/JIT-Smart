...
deepjit_predict = "python  -m baselines.CC2Vec.jit_DExtended -predict -pred_data data/deepjit/features_test.pkl -pred_data_cc2ftr data/cc2vec/test_cc2ftr.pkl -dictionary_data data/deepjit/dataset_dict.pkl -load_model model/cc2vec/snapshot/cc2vec/model/epoch_50.pt "
